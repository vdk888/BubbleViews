...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        render_as_batch=True,  # Support for SQLite batch operations
    )
...
async def run_async_migrations() -> None:
    ...
    This is required for aiosqlite async SQLite driver.
    """
...
def run_migrations_online() -> None:
    ...
    In async mode, this creates an event loop and runs
    async migrations.
    """
